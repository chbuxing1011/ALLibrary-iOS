...
- (void)requestProductListData
{
    ...
    [self.m_productList addObjectsFromArray:[NSArray arrayWithObjects:@"张三",@"李四",@"王五",@"赵六",@"陈七",@"朱八",nil]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row<[m_productList count]) {
            cell.textLabel.text = [NSString stringWithFormat:@"Row:%d %@",indexPath.row,[m_productList objectAtIndex:indexPath.row]] ;
    }
